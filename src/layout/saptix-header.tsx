...
export function SaptixHeader({
  ...
  const handleLogout = () => {
    // Clear wildcard cookie and redirect to central auth
    document.cookie = 'saptix_token=; domain=.saptix.tech; path=/; max-age=0';
    window.location.href = 'https://account.saptix.tech/login';
  };
